          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="flex-1 min-w-0 mb-4 lg:mb-0">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-2">
                ...
                <span>
                  Tối thiểu:{" "}
                  <strong>{formatCurrency(promotion.minBookingValue)}</strong>
                </span>
              </div>
            ...
            <div className="flex flex-col lg:items-end space-y-3">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="px-3 py-1 text-blue-600 hover:bg-blue-50 rounded flex items-center space-x-1"
                >
                ...
                <button
                  ...
                  className="px-3 py-1 text-green-600 hover:bg-green-50 rounded flex items-center space-x-1"
                >
                ...
                <button
                  ...
                  className="px-3 py-1 text-red-600 hover:bg-red-50 rounded flex items-center space-x-1"
                >
