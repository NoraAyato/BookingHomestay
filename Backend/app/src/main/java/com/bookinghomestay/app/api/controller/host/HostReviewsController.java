...
import com.bookinghomestay.app.application.host.reviews.command.HostApproveReviewCommandHandler;
...
public class HostReviewsController {
    ...
    private final HostApproveReviewCommandHandler hostApproveReviewCommandHandler;
    ...
    public ResponseEntity<ApiResponse<Void>> approveReview(@PathVariable String id) {
        String userId = SecurityUtils.getCurrentUserId();
        hostApproveReviewCommandHandler.handle(id, userId);
